...
def run_benchmark(
    ...
    if norm_method in ("all", "method4"):
        print("\n[Method 4] Ingesting PDF via Direct Long-Context Gemini Flash (Zero-Embedding JIT-RAG)...")
    ...
    for idx, item in enumerate(eval_items, 1):
        ...
        if norm_method in ("all", "method4") and direct_pipeline:
            ...
            direct_scores_list.append({"page": page_num, "scores": direct_eval})
